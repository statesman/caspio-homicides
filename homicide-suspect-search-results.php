...
<head>
	...
	<title>Suspect search results - Austin Homicide Project</title>
	<meta name="description" content="Suspect search returns from the Austin Homicide Project, an effort to document and understand violent crime in Austin and Central Texas.">
	<meta property="og:title" content="Suspect search results - Austin Homicide Project"/>
	<meta property="og:description" content="Suspect search returns from the Austin Homicide Project, an effort by the Austin American-Statesman to document and understand violent crime in Austin and Central Texas."/>
...
<div class="row">
	<div class="large-8 medium-8 columns">
		<div class="show-for-small-only">
			<div id="cbe76c000040db34db068745449301"></div>
			<script type="text/javascript" src="http://bridge.caspio.net/scripts/e1.js"></script>
			<script type="text/javascript">try{f_cbload("e76c000040db34db068745449301","http:");}catch(v_e){;}</script>
			<div id="cxkg"><a href="http://bridge.caspio.net/dp.asp?AppKey=e76c000040db34db068745449301">Click here</a> to load this Caspio <a href="http://www.caspio.com" title="Online Database">Online Database</a>.</div>
		</div>
		<div class="show-for-medium-up">
		<div id="cbe76c00004b6205c7a3c04d4995a1"></div>
		<script type="text/javascript" src="http://bridge.caspio.net/scripts/e1.js"></script>
		<script type="text/javascript">try{f_cbload("e76c00004b6205c7a3c04d4995a1","http:");}catch(v_e){;}</script>
		<div id="cxkg"><a href="http://bridge.caspio.net/dp.asp?AppKey=e76c00004b6205c7a3c04d4995a1">Click here</a> to load this Caspio <a href="http://www.caspio.com" title="Online Database">Online Database</a>.</div>
		</div>
	</div>
