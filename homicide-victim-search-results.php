...
<head>
  ...
  <title>Victim search results - Austin Homicide Project</title>
	<meta name="description" content="Victim search returns from the Austin Homicide Project, an effort to document and understand violent crime in Austin and Central Texas.">
	<meta property="og:title" content="Victim search results - Austin Homicide Project"/>
	<meta property="og:description" content="Victim search returns from the Austin Homicide Project, an effort by the Austin American-Statesman to document and understand violent crime in Austin and Central Texas."/>
...
<div class="row">
	<div class="large-8 medium-8 columns">
		<div class="show-for-small-only">
			<div id="cbe76c00000dcdbfd3bfb140409452"></div>
			<script type="text/javascript" src="http://bridge.caspio.net/scripts/e1.js"></script>
			<script type="text/javascript">try{f_cbload("e76c00000dcdbfd3bfb140409452","http:");}catch(v_e){;}</script>
			<div id="cxkg"><a href="http://bridge.caspio.net/dp.asp?AppKey=e76c00000dcdbfd3bfb140409452">Click here</a> to load this Caspio <a href="http://www.caspio.com" title="Online Database">Online Database</a>.</div>
		</div>
		<div class="show-for-medium-up">
		<div id="cbe76c0000e49d97e5cbff40d4b712"></div>
		<script type="text/javascript" src="http://bridge.caspio.net/scripts/e1.js"></script>
		<script type="text/javascript">try{f_cbload("e76c0000e49d97e5cbff40d4b712","http:");}catch(v_e){;}</script>
		<div id="cxkg"><a href="http://bridge.caspio.net/dp.asp?AppKey=e76c0000e49d97e5cbff40d4b712">Click here</a> to load this Caspio <a href="http://www.caspio.com" title="Online Database">Online Database</a>.</div>
		</div>
	</div>
