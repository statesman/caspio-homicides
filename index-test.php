...
<?php require_once('../caspio/dpload.txt');dpload('http://bridge.caspio.net/','e76c0000b0f97b2f653f4f5aa591','i');?>
<!-- End Caspio Deploy Code -->

      </div>
      <div class="show-for-small-only">
      <div id="cbe76c000014595bb724464fc3a456"></div>
    <script type="text/javascript" src="http://bridge.caspio.net/scripts/e1.js"></script>
    <script type="text/javascript">try{f_cbload("e76c000014595bb724464fc3a456","http:");}catch(v_e){;}</script>
    <div id="cxkg"><a href="http://bridge.caspio.net/dp.asp?AppKey=e76c000014595bb724464fc3a456">Click here</a> to load this Caspio <a href="http://www.caspio.com" title="Online Database">Online Database</a>.</div>
      </div>  
 
  </div>
	<div class="large-4 columns">
    	<h3>About this project</h3>
    	<p>The Austin Homicide Project is an effort by the Austin American-Statesman to document homicides in the City of Austin and Central Texas, and to provide a database of information about the cases so that the community can stay informed. This database is currently tracking all homicides in 2013, including justifiable homicides and cases classified as murders by the Austin Police Department. The project will expand to include other jurisdictions.</p>
        <!-- feed -->
